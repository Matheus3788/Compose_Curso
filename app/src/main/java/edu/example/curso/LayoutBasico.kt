...
import edu.example.curso.ui.theme.MySootheTheme
...
class LayoutBasico : ComponentActivity() {
...
private val favoriteCollectionsData = listOf(
    ...
    R.drawable.fc1_short_mantras to R.string.fc2_nature_meditations,
    R.drawable.fc1_short_mantras to R.string.fc3_stress_and_anxiety,
    R.drawable.fc1_short_mantras to R.string.fc4_self_massage,
    R.drawable.fc1_short_mantras to R.string.fc5_overwhelmed,
    R.drawable.fc1_short_mantras to R.string.fc6_nightly_wind_down
).map { DrawableStringPair(it.first, it.second) }
